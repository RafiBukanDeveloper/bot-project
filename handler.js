  ...
  try {
    ...
    try {
      ...
      if (user) {
        ...
        if (!isNumber(user.expg)) {
          user.expg = 0;
        }
        if (!isNumber(user.exphero)) {
          user.exphero = 0;
        }
        ...
        if (!isNumber(user.hero)) {
          user.hero = 1;
        }
        if (!isNumber(user.herolastclaim)) {
          user.herolastclaim = 0;
        }
        ...
        if (!isNumber(user.kerjadelapan)) {
          user.kerjadelapan = 0;
        }
        if (!isNumber(user.kerjadelapanbelas)) {
          user.kerjadelapanbelas = 0;
        }
        if (!isNumber(user.kerjadua)) {
          user.kerjadua = 0;
        }
        if (!isNumber(user.kerjaduabelas)) {
          user.kerjaduabelas = 0;
        }
        if (!isNumber(user.kerjaduadelapan)) {
          user.kerjaduadelapan = 0;
        }
        if (!isNumber(user.kerjaduadua)) {
          user.kerjaduadua = 0;
        }
        if (!isNumber(user.kerjaduaempat)) {
          user.kerjaduaempat = 0;
        }
        if (!isNumber(user.kerjaduaenam)) {
          user.kerjaduaenam = 0;
        }
        if (!isNumber(user.kerjadualima)) {
          user.kerjadualima = 0;
        }
        if (!isNumber(user.kerjaduapuluh)) {
          user.kerjaduapuluh = 0;
        }
        if (!isNumber(user.kerjaduasatu)) {
          user.kerjaduasatu = 0;
        }
        if (!isNumber(user.kerjaduasembilan)) {
          user.kerjaduasembilan = 0;
        }
        if (!isNumber(user.kerjaduatiga)) {
          user.kerjaduatiga = 0;
        }
        if (!isNumber(user.kerjaduatujuh)) {
          user.kerjaduatujuh = 0;
        }
        if (!isNumber(user.kerjaempat)) {
          user.kerjaempat = 0;
        }
        if (!isNumber(user.kerjaempatbelas)) {
          user.kerjaempatbelas = 0;
        }
        if (!isNumber(user.kerjaenam)) {
          user.kerjaenam = 0;
        }
        if (!isNumber(user.kerjaenambelas)) {
          user.kerjaenambelas = 0;
        }
        if (!isNumber(user.kerjalima)) {
          user.kerjalima = 0;
        }
        if (!isNumber(user.kerjalimabelas)) {
          user.kerjalimabelas = 0;
        }
        if (!isNumber(user.kerjasatu)) {
          user.kerjasatu = 0;
        }
        if (!isNumber(user.kerjasebelas)) {
          user.kerjasebelas = 0;
        }
        if (!isNumber(user.kerjasembilan)) {
          user.kerjasembilan = 0;
        }
        if (!isNumber(user.kerjasembilanbelas)) {
          user.kerjasembilanbelas = 0;
        }
        if (!isNumber(user.kerjasepuluh)) {
          user.kerjasepuluh = 0;
        }
        if (!isNumber(user.kerjatiga)) {
          user.kerjatiga = 0;
        }
        if (!isNumber(user.kerjatigabelas)) {
          user.kerjatigabelas = 0;
        }
        if (!isNumber(user.kerjatigapuluh)) {
          user.kerjatigapuluh = 0;
        }
        if (!isNumber(user.kerjatujuh)) {
          user.kerjatujuh = 0;
        }
        if (!isNumber(user.kerjatujuhbelas)) {
          user.kerjatujuhbelas = 0;
        }
        ...
        if (!isNumber(user.kyubilastclaim)) {
          user.kyubilastclaim = 0;
        }
        ...
        if (!isNumber(user.lastmancingextreme)) {
          user.lastmancingextreme = 0;
        }
        if (!isNumber(user.lastmancinghard)) {
          user.lastmancinghard = 0;
        }
        if (!isNumber(user.lastmancingnormal)) {
          user.lastmancingnormal = 0;
        }
        ...
        if (!isNumber(user.lastpekerjaan)) {
          user.lastpekerjaan = 0;
        }
        ...
        if (!isNumber(user.lastsironclaim)) {
          user.lastsironclaim = 0;
        }
        if (!isNumber(user.lastsmancingclaim)) {
          user.lastsmancingclaim = 0;
        }
        ...
        if (!isNumber(user.ramuancentaurlast)) {
          user.ramuancentaurlast = 0;
        }
        if (!isNumber(user.ramuangriffinlast)) {
          user.ramuangriffinlast = 0;
        }
        if (!isNumber(user.ramuanherolast)) {
          user.ramuanherolast = 0;
        }
        if (!isNumber(user.ramuankucinglast)) {
          user.ramuankucinglast = 0;
        }
        if (!isNumber(user.ramuankudalast)) {
          user.ramuankudalast = 0;
        }
        if (!isNumber(user.ramuankyubilast)) {
          user.ramuankyubilast = 0;
        }
        if (!isNumber(user.ramuannagalast)) {
          user.ramuannagalast = 0;
        }
        if (!isNumber(user.ramuanphonixlast)) {
          user.ramuanphonixlast = 0;
        }
        if (!isNumber(user.ramuanrubahlast)) {
          user.ramuanrubahlast = 0;
        }
        if (!isNumber(user.ramuanserigalalast)) {
          user.ramuanserigalalast = 0;
        }
        if (!isNumber(user.reglast)) {
          user.reglast = 0;
        }
      ...
      if (chat) {
        ...
        if (!("antilinkTiktok" in chat)) {
          chat.antilinkTiktok = false;
        }
        if (!("antilinkYt" in chat)) {
          chat.antilinkYt = false;
        }
        if (!("antilinkTele" in chat)) {
          chat.antilinkTele = false;
        }
        ...
        if (!("antilinkGroup" in chat)) {
          chat.antilinkGroup = false;
        }
        ...
        if (!("antilinkCh" in chat)) {
          chat.antilinkCh = false;
        }
      ...
      let bots = global.db.data.bots
            if (typeof bots !== 'object') global.db.data.bots = {}
            if (bots) {
                if (!('replyText' in bots)) {
                bots.replyText = {};
                }
                if (!('rating' in bots)) {
                bots.rating = {};
                ...
                if (!('gempaDateTime' in bots)) {
                bots.gempaDateTime = "";
                }
                if (!('otakuNow' in bots)) {
                bots.otakuNow = "";
                }
                if (!('komikuNow' in bots)) {
                bots.komikuNow = "";
                }
                if (!('sellRumah' in bots)) {
                bots.sellRumah = {};
                }
                if (!('invest' in bots)) {
                bots.invest = JSON.parse(fs.readFileSync('./json/crypto.json', 'utf-8'))
                }
                if (!('stock' in bots)) {
                bots.stock = JSON.parse(fs.readFileSync('./json/stock.json', 'utf-8'))
                }
                if (!('rumah' in bots)) {
                bots.rumah = JSON.parse(fs.readFileSync('./json/rumah.json', 'utf-8'))
                }
                if (!('saham' in bots)) {
                bots.saham = JSON.parse(fs.readFileSync('./json/saham.json', 'utf-8'))
                }
                if (!('jadwalsholat' in bots)) {
                bots.jadwalsholat = JSON.parse(fs.readFileSync('./json/jadwalsholat.json', 'utf-8'))
                }
            } else {
                global.db.data.bots = {
                replyText: {},
      ...
      if (settings) {
        ...
        if (!isNumber(settings.restartDB)) {
          settings.restartDB = 0;
        }
        if (!("backup" in settings)) {
          settings.backup = false;
        }
        if (!isNumber(settings.backupDB)) {
          settings.backupDB = 0;
        }
        if (!("resetlimit" in settings)) {
          settings.resetlimit = true;
        }
        if (!isNumber(settings.resetlimitDB)) {
          settings.resetlimitDB = 0;
        }
        if (!("cleartmp" in settings)) {
          settings.cleartmp = true;
        }
        if (!isNumber(settings.lastcleartmp)) {
          settings.lastcleartmp = 0;
        }
        if (!isNumber(settings.status)) {
          settings.status = 0;
        }
        if (!("anticall" in settings)) {
          settings.anticall = false;
        }
        if (!("antivirus" in settings)) {
          settings.antivirus = true;
        }
        if (!("toko" in settings)) {
          settings.toko = true;
        }
    ...
    let imagepp = await conn.profilePictureUrl(m.sender, 'image').catch(_ => 'https://files.catbox.moe/itl427.jpg')
    const RafiTampilan = (teks) => {
    const userTampilan = global.TampilanMode || 'teks'; // default button
...
return conn.sendMessage(m.chat, {
            ...
            contextInfo: {
                ...
                isForwarded: true,
                   ...
                   externalAdReply: {
                   title: `Mau Sewa Bot??, Chat`,
                   body: `Owner Bot: ` + setting.owner,
                   thumbnailUrl: setting.tampilan,
                   sourceUrl: 'https://rafi-panel.vercel.app/',
                   mediaType: 1,
    ...
    const RafiMenu = (teks) => {
const userMenu = global.menuMode || 'teks'; // default button
...
return conn.sendMessage(m.chat, {
    ...
    const rafiowner = JSON.parse(fs.readFileSync("./database/rafiowner.json"));
    const isBot = [global.conn.user.jid, ...rafiowner].map(v => v.replace(/[^0-9]/g, "") + "@s.whatsapp.net").includes(m.sender);
    const isROwner = [global.setting.owner].map(v => v.replace(/[^0-9]/g, "") + "@s.whatsapp.net").includes(m.sender);
    const isPembuat = [global.nodev].map(v => v.replace(/[^0-9]/g, "") + "@s.whatsapp.net").includes(m.sender);
    ...
    if (m.id.startsWith("BAE5") && m.id.length === 16 || m.isBaileys && m.fromMe) {
      return;
    }
    ...
    if (opts.self && !(m.fromMe || isROwner || isPembuat)) {
      return;
    }
    let rafigokil = global.db.data.chats[m.chat];
    if (rafigokil.adminonly === 'on' && !(isAdmin || isPembuat || isROwner)) {
      return;
    }
    ...
    for (let name in global.plugins) {
      ...
      // RegExp Mode?
      [[_prefix.exec(m.text), _prefix]] : Array.isArray(_prefix) ?
      // Array?
      _prefix.map(p => {
      ...
      // String?
      [[new RegExp(str2Regex(_prefix)).exec(m.text), new RegExp(str2Regex(_prefix))]] : [[[], new RegExp()]]).find(p => p[1]);
      ...
      if (usedPrefix = (match[0] || "")[0]) {
        ...
        if (plugin.rowner && !isROwner && !isPembuat) {
          fail("rowner", m, this);
          continue;
        }
        if (plugin.pembuat && !isPembuat) {
          fail("pembuat", m, this);
          continue;
        }
        if (plugin.owner && !isOwner && !isPembuat && !isBot) {
          fail("owner", m, this);
          continue;
        }
        if (plugin.mods && !isMods && !isPembuat) {
          fail("mods", m, this);
          continue;
        }
        if (plugin.premium && !isPrems && !isPembuat) {
          fail("premium", m, this);
          continue;
        }
        if (plugin.group && !m.isGroup) {
          ...
          continue;
        } else if (plugin.admin && !isAdmin && !isPembuat && !isOwner && !isBot) {
          fail("admin", m, this);
          continue;
        }
     ...
     caption: `Nomor Kakak Belum Terdaftar Di Dalam Database Bot Ini, Untuk Menggunakan Bot Ini Kakak Harus Daftar Dulu Dengan Menekan Tombol Di Bawah`,
     ...
     viewOnce: true
        ...
        if (plugin.rpg && m.isGroup && !global.db.data.chats[m.chat].rpg) {
          conn.sendMessage(m.chat, {
     image: {url: setting.tampilan},
     caption: `Group Ini Belum Di Kasih Akses Buat Fitur Ini.\n\n> Berikan Akses fitur ini dengan Menekan Tombol Di Bawah Ini`,
     footer: global.setting.namabot,
     buttons: [
     {
     buttonId: `.hidupkan rpg`, 
     buttonText: {
     displayText: 'BERIKAN AKSES FITUR RPG KETUAAA'
     },
     type: 1 
     }
     ],
     ...
     buttons: [
     {
     buttonId: `.hidupkan game`, 
     buttonText: {
     displayText: 'BERIKAN AKSES FITUR GAME KETUAAA'
     },
     type: 1 
     }
     ],
     ...
     buttons: [
     {
     buttonId: `.hidupkan nsfw`, 
     buttonText: {
     displayText: 'BERIKAN AKSES FITUR NSFW KETUAAA'
     },
     type: 1 
     }
     ],
     ...
     viewOnce: true
        ...
        if (!isPrems && plugin.limit && _user.limit < plugin.limit * 1) {
          m.reply('Limit Anda Udah Habis Ngab');
          continue;
        }
    ...
    if (global.db.data.settings[this.user.jid].recording) {
      await this.sendPresenceUpdate("recording", m.chat).catch(() => {});
    }
  }
}
			...
			if (chat.welcome) {
				...
				for (let user of participants) {
					...
					try {
						...
						let wel = 'https://8030.us.kg/file/kipQTYBYIVJg.jpeg' //https://telegra.ph/file/96c857aa540aef7d385eb.jpg
						let lea = 'https://8030.us.kg/file/IHWoBmIzeGLG.png' //https://telegra.ph/file/999b3af6dac1b48769ee6.jpg
						//await conn.sendMessage(id, { text: text, contextInfo: { mentionedJid: [user] }}, { quoted: null })

    const WelcomeModeMasuk = global.welcomeMode || 'gambar';
    if (WelcomeModeMasuk === 'teks') return this.sendMessage(id, { text }, { quoted: null })
await this.sendMessage(id, {
			...
			break
		case 'promote':
			text = (chat.sPromote || this.spromote || conn.spromote || '@user ```Sekarang Jadi Admin```')
		case 'demote':
			if (!text)
				text = (chat.sDemote || this.sdemote || conn.sdemote || '@user ```Sekarang Udah Di pecat Jadi Admin```')
			...
			if (chat.welcome) {
				...
				for (let user of participants) {
					...
					try {
						...
						let lea = 'https://8030.us.kg/file/IHWoBmIzeGLG.png' //https://telegra.ph/file/999b3af6dac1b48769ee6.jpg
						//await conn.sendMessage(id, { text: text, contextInfo: { mentionedJid: [user] }}, { quoted: null })
const WelcomeModeKeluar = global.welcomeMode || 'gambar';
    if (WelcomeModeKeluar === 'teks') return this.sendMessage(id, { text }, { quoted: null })
await this.sendMessage(id, {
            text: text,
            contextInfo: {
                mentionedJid: [id],
...
export async function groupsUpdate(groupsUpdate) {
  ...
  for (const groupUpdate of groupsUpdate) {
    ...
    if (groupUpdate.desc) {
      text = (chats.sDesc || this.sDesc || conn.sDesc || "```Deskripsi Udah Di Ubah Menjadi```\n@desc").replace("@desc", groupUpdate.desc);
    }
    if (groupUpdate.subject) {
      text = (chats.sSubject || this.sSubject || conn.sSubject || "```Nama Group Sudah Di Ubah Menjadi```\n@subject").replace("@subject", groupUpdate.subject);
    }
    if (groupUpdate.icon) {
      text = (chats.sIcon || this.sIcon || conn.sIcon || "```Foto PP Group Di Ubah Menjadi```").replace("@icon", groupUpdate.icon);
    }
    if (groupUpdate.revoke) {
      text = (chats.sRevoke || this.sRevoke || conn.sRevoke || "```Link Group Ini Di Ubah Menjadi```\n@revoke").replace("@revoke", groupUpdate.revoke);
    }
    if (!text) {
      continue;
    }
...
function pickRandom(list) {
  return list[Math.floor(list.length * Math.random())]
	...
	let msg = {
		rowner: `Perintah Ini Hanya Untuk \`Owner Utama\` Ku Kak!!`,
		owner: `Perintah Ini Hanya Untuk \`Owner\` Ku Kak!!`,
		mods: `Perintah Ini Hanya Untuk \`Pengguna Mods\` Ku Kak!!`,
		energy: 'Energi kamu telah habis. Silakan isi energi dengan ketik *.makan*',
		premium: `Perintah Ini Hanya Untuk \`Pengguna Premium\` Ku Kak!!`,
		group: `Perintah Ini Hanya Untuk Di \`Group\` Kak!!`,
		private: `Perintah Ini Hanya Untuk Di \`Private\` Kak`,
		admin: `Perintah Ini Hanya Untuk \`Admin\` Kak!!`,
		botAdmin: `\`bot Belum Jadi Admin Kak!!\`\n Harus Jadikan Admin Dulu Baru Bisa Gunakan Fitur Ini`,
		onlyprem: `Perintah Ini Hanya Untuk \`Pengguna Premium\` Ku Kak!!`,
		restrict: `Fitur Ini Di Matikan Oleh \`Utusan Developer\` Ku Kak!!`
	} [type]
