...
const defaultMenu = {
  before: `*\`${global.setting.namabot}\`*
\`\`\`Version : 15.12\`\`\`
\`\`\`Owner : @${global.setting.owner}\`\`\`
\`\`\`Devoloper : @${global.nodev}\`\`\`
\`\`\`Mode : %mode\`\`\`
...
handler.help = ['menudownloader']
handler.tags = ['rafi']
handler.command = /^(menudownloader|menudownload|downloadermenu|downloadmenu)$/i
