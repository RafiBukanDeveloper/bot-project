...
const handler = async (m, { conn, args, RafiTampilan }) => {
    const url = args[0]
    if (!url) return RafiTampilan('Eh, lupa kasih link Instagramnya? Contoh: .igdl https://www.instagram.com/p/xxxxx/')
...
handler.help = ['instagram *<url>* (5 Limit)']
handler.command = ['instagram', 'ig', 'instagramdl', 'igdl']
